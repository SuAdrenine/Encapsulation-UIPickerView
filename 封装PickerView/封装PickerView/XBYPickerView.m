...
@interface XBYPickerView() <UIGestureRecognizerDelegate>

@end

@implementation XBYPickerView
...
-(instancetype)initWithController:(UIViewController *)controller{
    ...
    if(self){
        ...
        //LHEditPickerView
        XBYEditPickerView *editView=[[XBYEditPickerView alloc]initWithFrame:CGRectMake(0, controller.view.bounds.size.height, controller.view.bounds.size.width, controller.view.bounds.size.height/5*2)];
...
+(instancetype)showWithController:(UIViewController *)controller andData:(NSArray *)data{
    XBYPickerView *bottom=[[self alloc]initWithController:controller];
...
+(void)showEditPickerViewWithController:(UIViewController *)controller andData:(NSArray *)data andBlock:(void (^)(NSString *temp))bottomResultPresent{
    XBYPickerView *bottom=[XBYPickerView showWithController:controller andData:data];
